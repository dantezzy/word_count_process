...
def extract_candidate_chunks(text, grammar=r'KT: {(<JJ>* <NN.*>+ <IN>)? <JJ>* <NN.*>+}'):
    ...
    # tokenize, POS-tag, and chunk using regular expressionsb
...
def extract_candidate_words(text, good_tags=set(['JJ','JJR','JJS','NN','NNP','NNS','NNPS'])): #JJ adjective
...
def score_keyphrases_by_textrank(text, n_keywords=0.9): # default value = 0.5
